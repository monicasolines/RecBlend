...
from .models import Docente, EstudianteMaterias, db, User, Materias, DocenteMaterias, Estudiante, EmailAuthorized, Evaluacion, Calificacion, Role, Grados
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(EstudianteMaterias, db.session))
